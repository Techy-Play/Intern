...
export default function OAorgPage() {
  return (
    <div className="min-h-screen bg-gray-50 py-10" style={{ fontFamily: 'apkProtocol, sans-serif' }}>

      {/* Section 1: Hero */}
      <VoidZeroBorder theme="light" showTopBorder={false} containerClassName="bg-white">
        <div className="px-10 pt-20 pb-12">
          <div className="flex flex-col gap-6 max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-normal text-black tracking-tight leading-[1.1]">
              Crowdsourcing justice <br /> in every company OA
            </h1>
            <p className="text-base text-gray-800 font-medium tracking-tight">
        ...
        <div className="w-full">
          <img
            ...
            className="w-full object-cover max-w-[100vw]"
          />
        </div>
      </VoidZeroBorder>
      ...
      <VoidZeroBorder theme="light" containerClassName="grid grid-cols-1 md:grid-cols-2 bg-white">
        <div className="p-10 border-b md:border-b-0 md:border-r border-[#e5e4e7] flex flex-col justify-between min-h-[300px] items-center text-center md:items-start md:text-left">
          <span className="text-base tracking-widest text-black font-medium">
            // OPEN SECRET OF TECH HIRING
          </span>
          <div className="space-y-1 pb-4 mt-10">
            <p className="text-lg font-medium text-black">Merit is tested</p>
            <p className="text-lg font-medium text-black">Cheating is rewarded</p>
          </div>
        </div>
        <div className="flex flex-row md:flex-col md:min-h-[300px]">
          <div className="p-4 md:p-10 flex-1 flex flex-col justify-center items-center md:items-start border-r md:border-r-0 md:border-b border-[#e5e4e7]">
            <h2 className="text-xl sm:text-2xl md:text-5xl font-normal text-black tracking-tight text-center md:text-left">
              Cheating wins
            </h2>
          </div>
      ...
      <VoidZeroBorder theme="light" containerClassName="flex flex-col bg-white">
        ...
        <div className="w-full bg-[#0a0a0a] text-white overflow-hidden py-0 px-6 md:px-12 flex items-end justify-center relative z-10 -mb-[1px]">
          <h2 className="lato-bold text-[12.5vw] xl:text-[175px] whitespace-nowrap leading-[0.75] uppercase tracking-tighter text-center select-none pt-4 sm:pt-6 md:pt-10 xl:pt-12 mb-[-0.05em]">
            THE PROBLEM
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr]">
          <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-[#e5e4e7] flex flex-col justify-start">
            <div>
              <span className="text-sm tracking-widest text-gray-500 font-medium mb-6 block">
                // 0 1
              </span>
              <h3 className="text-3xl md:text-4xl font-medium text-black mb-6 md:mb-8">The IIT/NIT Myth</h3>
            </div>
            <p className="text-base leading-loose text-black max-w-xl">
          ...
          <div className="flex flex-col">
            <div className="p-10 md:p-12 border-b border-[#e5e4e7] flex-1 flex flex-col justify-start">
              ...
              <h3 className="text-2xl md:text-3xl font-medium text-black mb-4">The OA Illusion</h3>
              <p className="text-[15px] leading-relaxed text-black max-w-sm">
            ...
            <div className="p-10 md:p-12 flex-1 flex flex-col justify-start">
              ...
              <h3 className="text-2xl md:text-3xl font-medium text-black mb-4">Telegram Economy</h3>
              <p className="text-[15px] leading-relaxed text-black max-w-sm">
      ...
      <VoidZeroBorder theme="light" containerClassName="bg-gray-50/50 py-12 text-center">
      ...
      <VoidZeroBorder theme="light" containerClassName="grid grid-cols-1 md:grid-cols-2 bg-white">
        <div className="p-8 py-10 md:p-8 flex flex-col justify-center items-center md:items-start order-2 md:order-1 text-center md:text-left">
          <div className="space-y-4 md:space-y-6 text-base md:text-xl text-black font-medium leading-relaxed">
            <p>
              Not a CP Expert<br />
              Not a LeetCode knight<br />
              Yet a 41 LPA offer<br />
        ...
        <div className="border-b md:border-b-0 md:border-l border-[#e5e4e7] p-0 bg-gray-50 order-1 md:order-2 overflow-hidden w-full h-full">
          <img
      ...
      <VoidZeroBorder theme="light" containerClassName="bg-white flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr]">
          {/* Left Image */}
          <div className="relative min-h-[300px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#e5e4e7]">
            <img
          ...
          <div className="flex flex-col">
            <div className="bg-[#2A0808] text-white p-8 md:p-12 flex-1 flex items-center">
              <h3 className="text-lg md:text-xl font-medium tracking-tight leading-relaxed max-w-sm">
            ...
            <div className="bg-white p-8 md:p-12 flex-1 flex items-center border-t border-[#e5e4e7]">
              <ul className="space-y-3 text-[13px] text-black font-medium list-none p-0 m-0">
